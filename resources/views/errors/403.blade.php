...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('error403/error403.css') }}">
...
<div id="container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 1080">
      ...
      <h1>Sorry You Can not earn this page </h1>
      <div id="details">
        <ul>
          <li><span>Return Back</span><span><a href="/admin/home">HOME</a></span></li>
        </ul>
